...
//     e.preventDefault();
//     const existUserBooking=JSON.parse(localStorage.getItem('userInfo'))||[]
...
//     }
//     const updateNewBooking=[...existUserBooking,newBooking]
//     localStorage.setItem('userInfo',JSON.stringify(updateNewBooking))
//     setFormData(
//       {
//         fullName: '',
//         email: '',
...
//             <TextField variant="outlined" type="text" name="fullName" value={formData.fullName} onChange={handlChange} />
//           </FormControl>
//         </Grid>
//         <Grid item xs={6}>
//           <Typography variant="caption">Select Pakage</Typography>
...
//         </Grid>
//         <Grid item xs={6}>
//           <Typography variant="caption">Adhar Detail</Typography>
...
//         <Grid item xs={6}>
//           <Typography variant="caption">PanCard Detail</Typography>
...
//         </Grid>
//         <Grid item xs={6}>
//           <Typography variant="caption">Full Adress</Typography>
