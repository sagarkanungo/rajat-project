...
function PackageSelectFor({ handleDrawerClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await set(ref(db, `users/${userId}/userPackageDetail`), updatedUserData);
  ...
  >
    ...
    <DialogContent>
      <DialogContentText id="alert-dialog-description">
        Your Package is successfully Sent to Administration, 
        we Will Call you for Furthur Detail And Check
      </DialogContentText>
    </DialogContent>
    <DialogActions>
      <Button variant="text" background='none' onClick={handleClose}>Close</Button>
